...
urlpatterns = [
    ...
    path(
        "domain/<int:pk>/",
        DomainViewSet.as_view({"get": "retrieve", "put": "update", "delete": "destroy"}),
        name="domain_by_id"
    ),
    ...
    path("product/<int:pk>/", ProductViewSet.as_view({"get": "retrieve", "put": "update", "delete":"destroy"}), name='product_by_id')
]
